...
<div class="contact-form">
<span class="wpcf7-form-control-wrap sub_title">
    <input type="password" id="password" name="password"  size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Password"></span>
</div>
</div>
...
<div class="contact-form">
<span class="wpcf7-form-control-wrap sub_title">
    <input type="password" id="password_confirmation" name="password_confirmation"  size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Confirm Password"></span>
</div>
</div>
</div>
