...
<h2 class="themesBazar_cat04"> <a href="{{ url('news/category/'.$skip_cat_3->id.'/'.$skip_cat_3->category_slug) }}"> <i class="las la-align-justify"></i> {{ $skip_cat_3->category_name }} </a> </h2>
...
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_5->id.'/'.$skip_cat_5->category_slug) }}">{{ $skip_cat_5->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_5->id.'/'.$skip_cat_5->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
...
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_8->id.'/'.$skip_cat_8->category_slug) }}">{{ $skip_cat_8->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_8->id.'/'.$skip_cat_8->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
...
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_7->id.'/'.$skip_cat_7->category_slug) }}">{{ $skip_cat_7->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_7->id.'/'.$skip_cat_7->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
<div class="white-bg">
...
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_6->id.'/'.$skip_cat_6->category_slug) }}">{{ $skip_cat_6->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_6->id.'/'.$skip_cat_6->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
<div class="white-bg">
...
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_9->id.'/'.$skip_cat_9->category_slug) }}">{{ $skip_cat_9->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_9->id.'/'.$skip_cat_9->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>

<div class="white-bg">

@foreach($skip_news_9 as $item) 
  @if($loop->index < 1)  
