...
<div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <p class="help-block error">{{ $errors->first('category_name') }}
                        @endif -->
                    @if ($errors->any())
    ...
    <form id="myForm2" method="post" action="{{ route('store.subcategory') }}">
    	@csrf 
   ...
   <button type="submit" class="btn btn-primary waves-effect waves-light">Save Subcategory</button>
