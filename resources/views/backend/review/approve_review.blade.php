 ...
 <div class="content">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <a href="{{ route('pending.review') }}" class="btn btn-blue waves-effect waves-light">Go To Pending Review </a>
                </ol>
            </div>
                                    <h4 class="page-title">Approve Review <span class="btn btn-danger"> {{ count($review) }} </span> </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
