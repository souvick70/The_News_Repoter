...
@if($status=='active')
<h4>Admin Account Type : <span class="text-success">Active</span></h4>

@else
<h4>Admin Account Type : <span class="text-danger">Inactive</span></h4>
<p class="text-danger"> *** Please Wait Admin Will Check And Active Your Acount Within (3-4) Working Days ***</p>
@endif
