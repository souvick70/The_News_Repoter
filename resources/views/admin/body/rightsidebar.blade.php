                    ...
                    <div class="tab-pane active" id="settings-tab" role="tabpanel">
                        ...
                        <div class="p-3">
                            <div class="alert alert-warning" role="alert">
                                <strong>Customize </strong> the overall color scheme, sidebar color, sidebar size etc.
                            </div>
                            ...
                            <!-- User info -->
                            <!-- <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">To Show User Profile In Sidebar</h6>

                            <div class="form-check form-switch mb-1">
                                <input type="checkbox" class="form-check-input" name="sidebar-user" value="fixed" id="sidebaruser-check" />
                                <label class="form-check-label" for="sidebaruser-check">Enable</label>
                                <label class="form-check-label" for="sidebaruser-check">Disable</label>
                            </div> -->
