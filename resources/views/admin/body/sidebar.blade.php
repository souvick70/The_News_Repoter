...
@if(Auth::user()->can('About.Us'))
        ...
        <li>
            ...
            <div class="collapse" id="about">
                <ul class="nav-second-level">
                    ...
                    <li>
                        <a href="{{route('all.privacy.policy')}}">Privacy Policy</a>
                    </li>
 ...
 @if(Auth::user()->can('admin.create_all_job_designation'))
        <li>
            <a href="#create_job_designation" data-bs-toggle="collapse">
                <i class="mdi mdi-account-circle-outline"></i>
                <span> Create Job Designation  </span>
                <span class="menu-arrow"></span>
            </a>
            <div class="collapse" id="create_job_designation">
                <ul class="nav-second-level">
                    <li>
                        <a href="{{ route('create.all.job.designation') }}">All Designation</a>
                    </li>
 ...
 @if(Auth::user()->can('admin.carrer'))
        <li>
            <a href="#carrer" data-bs-toggle="collapse">
                <i class="mdi mdi-account-circle-outline"></i>
                <span> Career  </span>
                <span class="menu-arrow"></span>
            </a>
            <div class="collapse" id="carrer">
                <ul class="nav-second-level">
                    <li>
                        <a href="{{ route('admin.carrer') }}">All Jobs</a>
                    </li>

                    <li>
                        <a href="{{route('all.show.job.application')}}">Job Appication By Candidate</a>
                    </li>
