...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Log In |Admin Login</title>
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                               ...
                               <u> <p class="text-white-50">Don't have an account? <a href="auth-register.html" class="text-white ms-1"><b>Sign Up</b></a></p></u>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            <u><script>document.write(new Date().getFullYear())</script> &copy; @Copyright by <a href="" class="text-white-50">News 24*7</a> </u>
        </footer>
