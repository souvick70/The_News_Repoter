...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Logout |  Admin Logout Message</title>
    ...
    <body class="authentication-bg authentication-bg-pattern">
        ...
        <footer class="footer footer-alt">
             <u><script>document.write(new Date().getFullYear())</script> &copy; @Copyright <a href="" class="text-white-50">News 24*7</a> </u>
        </footer>
